                ...
                const cardContent = `
                    <div class="card-body p-4" style="background: linear-gradient(to bottom, #f8f9fa, #ffffff); border-radius: 10px;">
                        ...
                        <div class="row mb-3 g-2">
                            <!-- Organization Card -->
                            <div class="col-12">
                                <div class="d-flex align-items-center p-2" style="background-color: #fff; border-radius: 8px; ">
                            ...
                            <!-- Venue Card -->
                            <div class="col-md-6">
                                <div class="d-flex align-items-center h-100 p-2" style="background-color: #fff; border-radius: 8px; ">
                        ...
                        <!-- Description -->
                        <div class="mt-3 p-3" style="background-color: #fff; border-radius: 8px; ">
